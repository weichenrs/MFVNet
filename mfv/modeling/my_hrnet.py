...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, model, num_classes=None, **kwargs):
        ...
        self.last_conv1 = nn.Conv2d(
                ...
                stride=1,
                padding=0)
        self.last_bn = BatchNorm2d(last_inp_channels, momentum=BN_MOMENTUM)
        self.last_relu = nn.ReLU(inplace=relu_inplace)
